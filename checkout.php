...
if (isset($_POST['submit'])) {
    ...
    unset($_SESSION['cart']);
        ...
        if($payment_type=='PayU'){
            ...
            $hash = "sha512($MERCHANT_KEY|txnid|amount|productinfo|firstname|email|udf1|udf2|udf3|udf4|udf5|
            udf6|udf7|udf8|udf9|udf10|$SALT)";
            // $hashSequence = "$MERCHANT_KEY|txnid|amount|productinfo|firstname|email|udf1|udf2|udf3|udf4|udf5||||||$SALT";
